ThunderRTC Server: ICE Configuration
=================================
...
**Setting appIceServers Across Server**
    ...
    thunderrtc.setOption("appIceServers", myIceServers);
...
In this example we are supplying a custom username for the TURN server.
    ...
    thunderrtc.on("getIceConfig", function(connectionObj, callback){
      var myIceServers=[
        {"url":"stun:stun.thunderrtc.com:3478"},
        {
          "url":        "turn:turn.thunderrtc.com:3478",
